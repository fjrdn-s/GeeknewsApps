...
class MovieVerticalAdapter (
...
) : RecyclerView.Adapter<MovieVerticalAdapter.TechVerticalViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieVerticalAdapter.TechVerticalViewHolder {
    ...
    override fun onBindViewHolder(holder: MovieVerticalAdapter.TechVerticalViewHolder, position: Int) {
