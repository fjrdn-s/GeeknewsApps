...
class TechVerticalAdapter (
        private val listVertical: ArrayList<ModelData>
) : RecyclerView.Adapter<TechVerticalAdapter.TechVerticalViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TechVerticalAdapter.TechVerticalViewHolder {
    ...
    override fun onBindViewHolder(holder: TechVerticalAdapter.TechVerticalViewHolder, position: Int) {
