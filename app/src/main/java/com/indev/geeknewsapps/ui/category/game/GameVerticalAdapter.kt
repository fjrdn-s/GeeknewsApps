...
class GameVerticalAdapter (
        private val listVertical: ArrayList<ModelData>
) : RecyclerView.Adapter<GameVerticalAdapter.TechVerticalViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GameVerticalAdapter.TechVerticalViewHolder {
    ...
    override fun onBindViewHolder(holder: GameVerticalAdapter.TechVerticalViewHolder, position: Int) {
